...
import { View, Text, TouchableOpacity, Modal, TouchableWithoutFeedback, TextInput, ScrollView } from 'react-native';
                    ...
                    <TouchableWithoutFeedback onPress={() => { }}>
                        <View style={{
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                                <Text style={{ color: colors.text, fontSize: 18, fontWeight: 'bold' }}>Select Category</Text>
