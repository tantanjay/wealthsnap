    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.termsText}>
                ...
                <Text style={styles.bold}>7.2 Automated Insights & Projections:</Text> Features such as Safe-to-Spend, Ghost Forecast, and Smart Alerts utilize local algorithms to provide financial projections. These insights are:{'\n'}
                ...
                <Text style={styles.bold}>7.3 Accuracy & Reliability:</Text> Any insights, metrics, calculations, or data (whether generated by AI or standard application logic) may be inaccurate, incomplete, or misleading. Check all outputs carefully. You are fully responsible for your own financial decisions.
            </Text>
