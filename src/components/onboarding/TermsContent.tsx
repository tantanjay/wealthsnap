    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.termsText}>
                ...
                • <Text style={styles.bold}>Data Use for Training:</Text> Please be advised that if you use a &quot;Free/Unpaid&quot; tier API key, Google may utilize your inputs to improve their models. We strongly recommend reviewing your Google AI Studio settings to manage your data preferences.
            </Text>
