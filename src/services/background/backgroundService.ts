...
import { checkGoalReachedNotifications } from '@services/domain/savingsGoalService';
...
TaskManager.defineTask(BACKGROUND_FETCH_TASK, async () => {
    try {
        ...
        // generated by the line above - processRecurrenceRules has no per-transaction hook
        // of its own to fire this from.
        await checkGoalReachedNotifications(await getCachedTransactions());
