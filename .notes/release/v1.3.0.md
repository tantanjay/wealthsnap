...
2. **Insights Screen**: Navigate to Insights and confirm all charts show skeletons before rendering the final graphs.
3. **Theme Adaptability**: Toggle Dark Mode and verify skeletons adjust their color accordingly.
