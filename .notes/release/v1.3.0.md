...
- **Duplicate Detection**: Automatically flags duplicate transactions matching existing records (by date+amount+category+notes).
...
- **Optimized Data Fetching**: Refactored `InsightScreen` data loading logic to ensure metrics are fully calculated before removing the loading state.
